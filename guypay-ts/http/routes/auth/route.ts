...
import { loginRequestDto, oauthRequestQuery, registerRequestDto } from "./dto";
...
export function authRoutes(authService: IAuthService) {
  ...
  router.post("/register", requireBody(registerRequestDto), controller.registerWithEmailAndPassword)
